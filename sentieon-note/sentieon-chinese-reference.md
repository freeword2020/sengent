...
当需要用中文快速解释 Sentieon 的模块和流程时，这个站可作为辅助材料。

### 平台化导航

当问题是“某个平台对应哪个 DNAscope 流程”时，这个站提供按平台拆分的目录入口。

### 二线支持和培训材料

当需要做内部交接、售前说明、客户中文答疑时，这个站可作为中文材料入口。
...
- 中文资料站帮助快速说明“是什么、有哪些流程”
- 官方资料负责确认“具体怎么跑、参数是什么、版本是否支持”

## 5. 对线程 019d5249 的作用

对线程 `019d5249-f1d6-75c0-8d3c-99e3e97e9835`，这份中文资料可用于:
